...
public class PersonResource {
    ...
    public ResponseEntity<PersonDTO> createPerson(@RequestBody PersonDTO personDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/people/" + result.getIdParty()))
            .headers(HeaderUtil.createEntityCreationAlert(ENTITY_NAME, result.getIdParty().toString()))
            .body(result);
    }

    /**
     * POST  /people/execute : Execute Bussiness Process person.
     *
     * @param personDTO the personDTO to Execute
     * @return the ResponseEntity with status Accepted and with body the  personDTO
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/people/execute")
    @Timed
    public ResponseEntity<PersonDTO> executedPerson(@RequestBody PersonDTO personDTO) throws URISyntaxException {
        log.debug("REST request to process Person : {}", personDTO);
        return new ResponseEntity<PersonDTO>(personDTO, null, HttpStatus.ACCEPTED);
    }
    ...
    public ResponseEntity<PersonDTO> updatePerson(@RequestBody PersonDTO personDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, personDTO.getIdParty().toString()))
            .body(result);
    }
