...
export class UniversityComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/university'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    executeProcess(data) {
        this.universityService.executeProcess(data).subscribe(
    ...
    updateRowData(event) {
        if (event.data.id !== undefined) {
            this.universityService.update(event.data)
                .subscribe((res: University) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        } else {
            this.universityService.create(event.data)
                .subscribe((res: University) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        }
    }

    private onRowDataSaveSuccess(result: University) {
        this.toasterService.showToaster('info', 'University Saved', 'Data saved..');
    }
