...
export class CourseComponent implements OnInit, OnDestroy {
    ...
    executeProcess(data) {
        this.courseService.executeProcess(data).subscribe(
    ...
    updateRowData(event) {
        if (event.data.id !== undefined) {
            this.courseService.update(event.data)
                .subscribe((res: Course) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        } else {
            this.courseService.create(event.data)
                .subscribe((res: Course) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        }
    }

    private onRowDataSaveSuccess(result: Course) {
        this.toasterService.showToaster('info', 'Course Saved', 'Data saved..');
    }
