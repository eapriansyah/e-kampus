...
export class LocationComponent implements OnInit, OnDestroy {
    ...
    executeProcess(data) {
        this.locationService.executeProcess(data).subscribe(
    ...
    updateRowData(event) {
        if (event.data.id !== undefined) {
            this.locationService.update(event.data)
                .subscribe((res: Location) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        } else {
            this.locationService.create(event.data)
                .subscribe((res: Location) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        }
    }

    private onRowDataSaveSuccess(result: Location) {
        this.toasterService.showToaster('info', 'Location Saved', 'Data saved..');
    }
