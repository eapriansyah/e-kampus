...
@Component({
    selector: 'jhi-student-periods',
    templateUrl: './student-periods.component.html'
})
export class StudentPeriodsComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.studentPeriodsService.search({
                page: this.page - 1,
