...
@Component({
    selector: 'jhi-student-course-score',
    templateUrl: './student-course-score.component.html'
})
export class StudentCourseScoreComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.studentCourseScoreService.search({
                page: this.page - 1,
