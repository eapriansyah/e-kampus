...
export class DegreeComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/degree'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    sort() {
        ...
        if (this.predicate !== 'idDegree') {
            result.push('idDegree');
        }
        return result;
    }
    ...
    executeProcess(data) {
        this.degreeService.executeProcess(data).subscribe(
    ...
    updateRowData(event) {
        if (event.data.id !== undefined) {
            this.degreeService.update(event.data)
                .subscribe((res: Degree) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        } else {
            this.degreeService.create(event.data)
                .subscribe((res: Degree) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        }
    }

    private onRowDataSaveSuccess(result: Degree) {
        this.toasterService.showToaster('info', 'Degree Saved', 'Data saved..');
    }
