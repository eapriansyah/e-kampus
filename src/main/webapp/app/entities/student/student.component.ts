...
export class StudentComponent implements OnInit, OnDestroy {
    ...
    executeProcess(data) {
        this.studentService.executeProcess(data).subscribe(
    ...
    updateRowData(event) {
        if (event.data.id !== undefined) {
            this.studentService.update(event.data)
                .subscribe((res: Student) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        } else {
            this.studentService.create(event.data)
                .subscribe((res: Student) =>
                    this.onRowDataSaveSuccess(res), (res: Response) => this.onRowDataSaveError(res));
        }
    }

    private onRowDataSaveSuccess(result: Student) {
        this.toasterService.showToaster('info', 'Student Saved', 'Data saved..');
    }
