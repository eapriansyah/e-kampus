...
export class BuildingService {
    ...
    private resourceUrl = 'api/buildings';
    private resourceSearchUrl = 'api/_search/buildings';
    ...
    find(id: any): Observable<Building> {
	...
	executeProcess(building: any): Observable<String> {
        const copy = this.convert(building);
